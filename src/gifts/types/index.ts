...
export class PaginateAndFilterResponse {
  ...
  @ApiProperty({ type: Gifts, isArray: true })
  rows: Gifts;
}

export class Bestsellers extends Gifts {
  @ApiProperty({ example: true })
  bestseller: boolean;
}
...
export class NewGifts extends Gifts {
  @ApiProperty({ example: true })
  new: boolean;
}
...
export class SearchByLetterResponse extends Gifts {
...
export class GetByNameResponse extends Gifts {
  @ApiProperty({ example: 'Provident incidunt.' })
  name: string;
}
...
export class FindOneResponse extends Gifts {}

export interface IGiftsQuery {
  limit: string;
  offset: string;
...
export interface IGiftsFilter {
  gift_manufacturer: string | undefined;
